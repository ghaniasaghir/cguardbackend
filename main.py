...
def risk_color(pct):
    # Public-facing flood risk scale.
    # 0-25 Normal, 25-45 Low, 45-65 Medium, 65-80 High, 80-95 Very High, 95+ Exceptionally High.
    pct = float(pct)
...
def risk_label(pct):
    # Public-facing flood risk scale.
    # Important: 21-24% must still be Normal for the C-Guard UI.
    pct = float(pct)
